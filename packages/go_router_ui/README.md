## Go Router UI package

Go Router UI package containing a general design system.
...
│   │       ├── colors
│   │       ├── icons
│   │       │      ├── go_router_icons_dark.dart
│   │       │      ├── go_router_icons_light.dart
│   │       │      └── go_router_icons.dart 
│   │       ├── spacing
│   │       ├── theme
│   │       ├── typography
│   │       └── widgets
│   │             ├── go_router_app_bar.dart
│   │             ├── go_router_outlined_button.dart
│   │             └── go_router_text_field.dart 
│   ├── go_router_ui.dart
│   ├── .gitignore
...
```
2) In `go_router_icons_light.dart` add the icon with its color respectively of the theme. 
...
3) In `go_router_icons_dark.dart` add the icon with its color respectively of the theme. 
